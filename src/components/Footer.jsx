  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a 
                href="https://www.facebook.com/profile.php?id=100009471733594"
                aria-label="facebook"
            ...
            <li>
              <a
                href="https://www.instagram.com/_apol_aidaas?igsh=c2swYXk2bW5kbXZ4&utm_-_source=qr"
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/sadia-khisha-2a7aab251"
                aria-label="linkedin"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
      ...
      <div className="footer--content--container">
        <p className="footer--content">Réalisé avec 💖 par SADIA @ 2024</p>
        <div className="footer--social--icon">
        </div>
      </div>
    </footer>
